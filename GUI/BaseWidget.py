...
class BaseWidget(object):
    def setupUi(self, Form):
        ...
        self.numClonesLineEdit = QtWidgets.QLineEdit(self.layoutWidget)
        self.numClonesLineEdit.setObjectName("numClonesLineEdit")
        self.numClonesHorBox.addWidget(self.numClonesLineEdit)
        self.numClonesMinus = QtWidgets.QPushButton(self.layoutWidget)
        self.numClonesMinus.setObjectName("numClonesMinus")
        self.numClonesHorBox.addWidget(self.numClonesMinus)
        self.numClonesPlus = QtWidgets.QPushButton(self.layoutWidget)
        self.numClonesPlus.setObjectName("numClonesPlus")
        self.numClonesHorBox.addWidget(self.numClonesPlus)
    ...
    def retranslateUi(self, Form):
        ...
        self.numClonesLineEdit.setText(_translate("Form", "1"))
        self.numClonesMinus.setText(_translate("Form", "-"))
        self.numClonesPlus.setText(_translate("Form", "+"))
